...
context('Cluster View', () => {
  ...
  it('cluster view shows event logs', () => {
    ...
    clusterPage.getEventLogTableHeader(3).contains('First Name')
    clusterPage.getEventLogTableHeader(4).contains('First Name Aliases')
    clusterPage.getEventLogTableHeader(5).contains('Middle Names')
    clusterPage.getEventLogTableHeader(6).contains('Last Name')
    clusterPage.getEventLogTableHeader(7).contains('Last Name Aliases')
    clusterPage.getEventLogTableHeader(8).contains('Date Of Birth')
    clusterPage.getEventLogTableHeader(9).contains('Date Of Birth Aliases')
    clusterPage.getEventLogTableHeader(10).contains('Postcodes')
    clusterPage.getEventLogTableHeader(11).contains('CROs')
    clusterPage.getEventLogTableHeader(12).contains('PNCs')
    clusterPage.getEventLogTableHeader(13).contains('Source System')
    clusterPage.getEventLogTableHeader(14).contains('Event Type')
