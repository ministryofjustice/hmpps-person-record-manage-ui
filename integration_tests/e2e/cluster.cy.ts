...
context('Cluster View', () => {
  ...
  it('cluster view shows event logs', () => {
    ...
    clusterPage.getEventLogTableHeader(5).contains('Master Defendant ID')
    ...
    clusterPage.getEventLogTableHeader(20).contains('Source System')
    ...
    clusterPage.getEventLogTableRow(1).contains('6639fd43-9d01-450a-87be-557bd3bcf48e')
