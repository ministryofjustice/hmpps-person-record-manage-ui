...
context('Cluster View', () => {
  ...
  it('cluster view shows event logs', () => {
    ...
    clusterPage.getEventLogTableHeader(3).contains('Event Type')
    clusterPage.getEventLogTableHeader(4).contains('Source System ID')
    clusterPage.getEventLogTableHeader(5).contains('First Name')
    clusterPage.getEventLogTableHeader(6).contains('First Name Aliases')
    clusterPage.getEventLogTableHeader(7).contains('Middle Names')
    clusterPage.getEventLogTableHeader(8).contains('Last Name')
    clusterPage.getEventLogTableHeader(9).contains('Last Name Aliases')
    clusterPage.getEventLogTableHeader(10).contains('Date Of Birth')
    clusterPage.getEventLogTableHeader(11).contains('Date Of Birth Aliases')
    clusterPage.getEventLogTableHeader(12).contains('Postcodes')
    clusterPage.getEventLogTableHeader(13).contains('CROs')
    clusterPage.getEventLogTableHeader(14).contains('PNCs')
    clusterPage.getEventLogTableHeader(15).contains('Record Merged To')
    clusterPage.getEventLogTableHeader(16).contains('Sentence Dates')
    clusterPage.getEventLogTableHeader(17).contains('Override Marker')
    clusterPage.getEventLogTableHeader(18).contains('Override Scopes')
    ...
    clusterPage.getEventLogTableRow(2).contains('Record Updated')
  })
